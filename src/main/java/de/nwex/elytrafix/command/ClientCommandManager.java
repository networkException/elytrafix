package de.nwex.elytrafix.command;

import com.mojang.brigadier.StringReader;
import com.mojang.brigadier.exceptions.CommandSyntaxException;
import de.nwex.elytrafix.util.Chat;
import de.nwex.elytrafix.util.TextUtil;
...
public class ClientCommandManager
{
    ...
    public static int executeCommand(StringReader reader, String command)
    {
        ...
        {
            Chat.error(new LiteralText("Command"), new LiteralText(exception.getClass().getName() + ": " + exception.getMessage()).setStyle(new Style().setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new LiteralText(TextUtil.stackTraceToString(exception)).formatted(Formatting.RED)))));
        }
