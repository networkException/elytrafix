...
public class FileUtil
{
    ...
    public static void fileInputIterator(File file, BiConsumer<String, Integer> iterator)
    {
        ...
        {
            Chat.error(new LiteralText("File"), new LiteralText(exception.getClass().getName() + ": " + exception.getMessage()).setStyle(new Style().setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new LiteralText(TextUtil.stackTraceToString(exception)).formatted(Formatting.RED)))));
        }
    }
